...
def generate_node_status_from_database(config, owner, repo, repo_type, begin_date, end_date):
...
DESCRIPTION
    ...
    begin_date = datetime.datetime.strptime(begin_date, "%Y-%m-%d")
    end_date = datetime.datetime.strptime(end_date, "%Y-%m-%d")
    generate_node_status_from_database(config, owner, repo, repo_type, begin_date, end_date)
